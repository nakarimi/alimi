      ...
      <table class="cu_in_table pull-left">
        <thead>
          <tr>
            ...
            <td style="width:80%;">
              {{ @$data['type'] . '-' . ($data['sales']['project'] ? $data['sales']['project']['pro_data']['reference_no'] : '') . '-' . $data['sales']['serial_no'] }}
            </td>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>نام قرارداد:</td>
            <td><span
                class="cu_name">{{ $data['sales']['project'] ? $data['sales']['project']['pro_data']['title'] : '-' }}</span>
            </td>
          </tr>
          <tr>
            <td>نهاد:</td>
            <td><span class="" dir="ltr"
                style="text-align:left;">{{ @$data->client }}</span></td>
          </tr>
        </tbody>
      </table>
    </div>
          ...
          <div class="inv_stamp pull-left margin-top-30" style="width:50%;">
            <div class="inv_desc">
              ...
              <div class="inv_desc_detail">
                ...
                "{{ @$data['sales']['project']['pro_data']['client']['name'] }}" به ارزش
                "{{ @$data['sales']['total'] }} افغانی" به
                فروش رسید.
              </div>
            </div>
