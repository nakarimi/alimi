...
{{-- <body> --}}
  ...
  <div class="container mt-5">
    <h2 class="right-border">معلومات قرارداد</h2>
      ...
      <table class="cu_in_table pull-left">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="" dir="ltr" style="text-align:left;">{{ @$data->contract_date }}</span></td>
          </tr>
          <tr>
            <td>تاریخ ختم قرارداد:</td>
            <td><span class="" dir="ltr" style="text-align:left;">{{ @$data->contract_end_date }}</span></td>
          </tr>
          <tr>
            <td>شماره شناسایی قرارداد:</td>
          ...
          <tr>
            <td>تضمین حسن اجرا:</td>
            <td><span class="" dir="ltr" style="text-align:left;">{{ @$data->project_guarantee }}</span></td>
          </tr>
        </tbody>
      </table>
    </div>
        ...
        <div class="table-prices-note">
          <table class="table-prices text-right float-left">
            <thead>
              ...
              <tr>
                <th style="text-align:left !important;">ارزش قرارداد :</th>
