...
export default {
  data () {
    return {
      ...
      suggestedFriends: [
        { name: 'Carissa Dolle', avatar: '',  mutualFriends: 6 },
        { name: 'Liliana Pecor', avatar: '',  mutualFriends: 3 },
        { name: 'Isidra Strunk', avatar: '',  mutualFriends: 2 },
        { name: 'Gerald Licea',  avatar: '',  mutualFriends: 1 },
        { name: 'Kelle Herrick', avatar: '',  mutualFriends: 1 },
        { name: 'Cesar Lee',     avatar: '', mutualFriends: 1 },
        { name: 'John Doe',      avatar: '', mutualFriends: 1 },
        { name: 'Tonia Seabold', avatar: '', mutualFriends: 1 }
      ],
      userLatestPhotos: [
        '',
        '',
      ...
      userPosts: [
        {
          ...
          comments   : 77,
          usersLiked : [
            { name: 'Trina Lynes',       img: ''},
            { name: 'Lilian Nenez',      img: ''},
            { name: 'Alberto Glotzbach', img: ''},
            { name: 'George Nordick',    img: ''},
            { name: 'Vennie Mostowy',    img: ''}
          ],
          commentbox : '',
          usersCommented: [
            {
        ...
        },
        {
          ...
          comments   : 105,
          usersLiked : [
            { name: 'Lai Lewandowski',   img: ''},
            { name: 'Elicia Rieske',     img: ''},
            { name: 'Darcey Nooner',     img: ''},
            { name: 'Julee Rossignol',   img: ''},
            { name: 'Jeffrey Gerondale', img: ''}
          ],
          commentbox: '',
          usersCommented: [
            {
      ...
      suggestedPages: [
        { img: '', title: 'Rockose',      type: 'Company'          },
        { img: '', title: 'The Devil\'s', type: 'Clothing Store'   },
        { img: '', title: 'The Magician', type: 'Public Figure'    },
        { img: '', title: 'AC/DC',        type: 'Music'            },
        { img: '', title: 'eat hard',     type: 'restaurant / bar' },
        { img: '', title: 'B4B',          type: 'Beauty Store'     },
        { img: '', title: 'Kylie Jenner', type: 'Public Figure'    },
        { img: '', title: 'RDJ',          type: 'Actor'            },
        { img: '', title: 'Taylor Swift', type: 'Music'            }
      ],
      polls: [
        {
          id: 59,
          ...
          options: [
            {
              ...
              voted      : 58,
              usersVoted : [
                { name: 'Tonia Seabold',  avatar: ''},
                { name: 'Carissa Dolle',  avatar: ''},
                { name: 'Kelle Herrick',  avatar: ''},
                { name: 'Len Bregantini', avatar: ''},
                { name: 'John Doe',       avatar: ''},
                { name: 'Tonia Seabold',  avatar: ''},
                { name: 'Dirk Fornili',   avatar: ''}
              ]
            },
            {
              ...
              voted      : 16,
              usersVoted : [
                { name: 'Liliana Pecor',      avatar: ''},
                { name: 'Kasandra Nalevanko', avatar: ''}
              ]
            },
            {
              text       : 'mark ruffalo',
              value      : 'mark ruffalo',
              voted      : 8,
              usersVoted : [{ name: 'Lorelei Lacsamana', avatar: ''}]
            },
            {
              text       : 'Chris Evans',
              value      : 'chris evans',
              voted      : 16,
              usersVoted : [
                { name: 'Jeanie Bulgrin', avatar: ''},
                { name: 'Graig Muckey',   avatar: ''}
              ]
            }
          ]
